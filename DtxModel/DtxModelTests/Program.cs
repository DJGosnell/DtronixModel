		...
		static void insertTests() {
			...
			timeFunc("Manual Normal Insert", 50, () => {
				using (var command = connection.CreateCommand()) {
					command.CommandText = @"INSERT INTO Customers ('CustomerID', 'CompanyName', 'ContactName', 'Address', 'City', 'Region', 'PostalCode', 'Country', 'Phone', 'Fax') VALUES (@v0, @v1, @v2, @v3, @v4, @v5, @v6, @v7, @v8, @v9)";
