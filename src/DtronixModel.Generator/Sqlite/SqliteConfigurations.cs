...
namespace DtronixModel.Generator.Sqlite
{
    public class SqlitePragmaConfigurations
    {
        ...
        static SqlitePragmaConfigurations()
        {
            ...
            {
                "auto_vacuum", "automatic_index", "busy_timeout", "cache_size", "cache_spill", "checkpoint_fullfsync",
                "defer_foreign_keys", "encoding", "foreign_key_check", "foreign_keys", "full_column_names", "fullfsync",
                "integrity_check",
                "journal_mode", "journal_size_limit", "legacy_file_format", "locking_mode", "max_page_count",
                "page_size", "query_only", "quick_check",
                "read_uncommitted", "recursive_triggers", "reverse_unordered_selects", "schema_version", "user_version",
                "secure_delete", "soft_heap_limit",
